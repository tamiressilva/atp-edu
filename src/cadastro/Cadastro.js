...
class Cadastro extends Component {
    ...
    async gravar(e) {
        ...
        try {
            const response = await firebase.auth().createUserWithEmailAndPassword(this.state.email, this.state.senha);
               ...
               <div className="home-page">
                   ...
                   <div className="page">
                       <div className="formLogin" >
                           ...
                           <input type="text" placeholder="Digite seu nome" autoFocus maxLength="30"
                                  onChange={(e) => this.setState({nome: e.target.value})}/>
                           <label htmlFor="text">Sobrenome</label>
                           <input type="text" placeholder="Digite seu sobrenome" maxLength="30"
                           ...
                           <input type="email" placeholder="Digite seu e-mail" maxLength="40"
